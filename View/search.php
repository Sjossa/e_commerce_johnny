				...
				<div class="card shadow-sm h-100 border-light rounded-3 hover-zoom">
					<div class="card-body">
						...
						<div class="d-flex justify-content-between align-items-center">
							<!-- Bouton Modifier -->
							<a href="index.php?component=article&id=<?= htmlspecialchars($article['id_article']); ?>"
							   class="btn btn-warning btn-sm">Modifier</a>
							<!-- Bouton Détails avec toggle -->
							<button onclick="toogleUser(<?php echo htmlspecialchars($article['id_article']); ?>)"
									class="btn btn-secondary btn-sm">Détails
							</button>
						</div>

  ...
  <form action="" method="post"
    ...
    <div class="mb-3">
      ...
      <textarea name="description" id="description" class="form-control" rows="3"
        ...
        required><?php echo isset($article['description']) ? htmlentities($article['description']) : ''; ?></textarea>
    </div>
    <div class="mb-3">
      <label for="image" class="form-label">Image</label>
      <input type="file" name="image" id="image" class="form-control" <?php echo !empty($article['image']) ? '' : 'required'; ?>>
    ...
    <div class="mb-3">
      ...
      <select name="id_categorie" id="id_categorie" class="form-select" required>
        <?php foreach ($categories as $categorie): ?>
          <option value="<?php echo htmlentities($categorie['id_categorie']); ?>" <?php echo (isset($article['id_categorie']) && $article['id_categorie'] == $categorie['id_categorie']) ? 'selected' : ''; ?>>
